     ...
     <input class="form-control" type="hidden" name="id" id="id" value="<?php echo $dato['id']?>" max="255" required >
        ...
        <div class="input-group">
            ...
            <div class="form-group col-md-5">
                ...
                <textarea class="form-control z-depth-1" name="alimentacion" id="alimentacion" required max="255" rows="4"><?php echo $dato['alimentacion']?></textarea>
                <p class="help-block">Alimentacion de la mascota.</p>
            </div>
                
            <div class="form-group col-md-5">
                <label>Observacion</label>
                <textarea class="form-control z-depth-1" name="observacion" id="observacion" required max="255" rows="4"><?php echo $dato['observacion']?></textarea>
